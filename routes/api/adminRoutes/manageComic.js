...
const validateComic = require('../../../validation/AdminValidation/comic');
        ...
        .then(comic => {
           if (comic) {
               ...
               Comic.findOneAndUpdate(
                   ...
                   .then(comic => res.json('Comic has been updated'));
               ...
               //   Save Profile
               new Comic(comicFields).save().then(comic => res.json('Comic has been uploaded'));
           }
        });
});
